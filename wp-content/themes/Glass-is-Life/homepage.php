                    ...
                    <?php while ( have_posts() ) : the_post(); ?>
                        <li <?php if(get_field('taste_image') == null){echo 'class="display-none"';} ?> >
                            <div class="theposts">
                                ...
                                <div class="watch"><p>LIHAT VIDEO</p><a class="taste-youtube" href="http://www.youtube.com/embed/<?php the_field('taste_youtube') ?>?rel=0&amp;wmode=transparent"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/play_icon_rasa.gif"></a></div>
                            </div>
                        </li>
                        <li <?php if(get_field('quality_image') == null){echo 'class="display-none"';} ?> >
                            <div class="theposts">
                                ...
                                <div class="linefront"></div>
                                <div class="lineback"></div>
                                <div class="watch"><p>LIHAT VIDEO</p><a class="quality-youtube" href="http://www.youtube.com/embed/<?php the_field('quality_youtube') ?>?rel=0&amp;wmode=transparent"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/play_icon_kualitas.gif"></a></div>
                            </div>
                        </li>
                        <li <?php if(get_field('sus_image') == null){echo 'class="display-none"';} ?> >
                            <div class="theposts">
                                ...
                                <div class="linefront"></div>
                                <div class="lineback"></div>
                                <div class="watch"><p>LIHAT VIDEO</p><a class="sus-youtube" href="http://www.youtube.com/embed/<?php the_field('sus_youtube') ?>?rel=0&amp;wmode=transparent"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/play_icon_kelestarian.gif"></a></div>
                            </div>
                        </li>
                        <li <?php if(get_field('health_image') == null){echo 'class="display-none"';} ?> >
                            <div class="theposts">
                                ...
                                <div class="linefront"></div>
                                <div class="lineback"></div>
                                <div class="watch"><p>LIHAT VIDEO</p><a class="health-youtube" href="http://www.youtube.com/embed/<?php the_field('health_youtube') ?>?rel=0&amp;wmode=transparent"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/play_icon_kesehatan.gif"></a></div>
                            </div>
                        </li>
                    <?php endwhile; ?>
                    </ul>
